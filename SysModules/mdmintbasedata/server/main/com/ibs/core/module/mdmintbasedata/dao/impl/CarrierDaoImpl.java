...
public class CarrierDaoImpl extends BaseEntityDao<Carrier> implements
	...
	public List<CarrierSimple> findUniversal(String orgCodeOrNameOrPinYin,
		...
		sql
				.append("select ID as id ,CODE as code,NAME as name   "
						+ " from core.t_MDM_CARRIERS where 1=1 ");
	...
	public IPage<Carrier> findCarrierNotInGroup(String operateOrgCode,
		...
		StringBuffer sql = new StringBuffer();
		sql
				.append("select  o.id as id,o.code as code ,o.name as name  from core.t_mdm_carriers o left join  "
						+ " (select distinct ogo.carrier_id fid from core.t_mdm_carrier_group_carrier ogo "
						+ "left join core.t_mdm_carrier_group og on ogo.carrier_group_id=og.id  where "
