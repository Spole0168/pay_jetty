...
public interface IDataDictService {
	...
	/** 提现交易 的 子类型 */
	public static final String DATA_DICT_TYPE__TRANS_SUB_TYPE_FOR_WITHDRAW = "TRANS_SUB_TYPE_FOR_WITHDRAW";
	public static final String DATA_DICT_TYPE__TRANS_SUB_TYPE_FOR_WITHDRAW_VALUE = "提现审核";
...
//	public static final String DATA_DICT_TYPE__BANK_TRANS_STATUS_VALUE = "银行交易状态";
	...
	/** 提现审核状态 */
	public static final String DATA_DICT_TYPE__WITHDRAW_CASH_APPROVAL_STATUS = "WITHDRAW_CASH_APPROVAL_STATUS";
	public static final String DATA_DICT_TYPE__WITHDRAW_CASH_APPROVAL_STATUS_VALUE = "提现审核状态";
	/** 卡片帐**********end**************************** */
...
//	public static final String DATA_DICT_TYPE__CITY_VALUE = "城市";
	...
	/**银行业务类型*/
	public static final String DATA_DICT_TYPE__BANK_INTF_TYPE = "BANK_INTF_TYPE";
	public static final String DATA_DICT_TYPE__BANK_INTF_TYPE_VALUE = "银行业务类型";
	...
	/** 支付通道名称 */
	public static final String DATA_DICT_TYPE__PAYMENT_CHANNEL_NAME = "PAYMENT_CNL_NAME";
	public static final String DATA_DICT_TYPE__PAYMENT_CHANNEL_NAME_VALUE = "支付通道名称";
	
	/** 支付通道类型 */
	public static final String DATA_DICT_TYPE__PAYMENT_CHANNEL_TYPE = "PAYMENT_CNL_TYPE";
	public static final String DATA_DICT_TYPE__PAYMENT_CHANNEL_TYPE_VALUE = "支付通道类型";
	
	/** 支付通道接入类型 */
	public static final String DATA_DICT_TYPE__PAYMENT_CHANNEL_ACCESS_TYPE = "PAYMENT_CNL_ACCESS_TYPE";
	public static final String DATA_DICT_TYPE__PAYMENT_CHANNEL_ACCESS_TYPE_VALUE = "支付通道接入类型";
	
	/** 到账时效 */
	public static final String DATA_DICT_TYPE__PAYMENT_CHANNEL_VALUE_DATE_TYPE = "PAYMENT_CNL_VALUE_DATE_TYPE";
	public static final String DATA_DICT_TYPE__PAYMENT_CHANNEL_VALUE_DATE_TYPE_VALUE = "到账时效";
	/** 公共+运维管理**********END**************************** */
	...
	/**支付方式 手工入金**/
	public static final String DATA_DICT_TYPE__PAY_MENT = "Payment_TYPE";
	public static final String DATA_DICT_TYPE__PAY_MENT_VALUE = "支付方式";
	...
	/** 提现管理/导出状态 */
	public static final String DATA_DICT_TYPE__WITHDRAW_RECORD_HANDLE_STATUS = "WITHDRAW_RECORD_HANDLE_STATUS";
	public static final String DATA_DICT_TYPE__WITHDRAW_RECORD_HANDLE_STATUS_VALUE = "提现管理/导出状态";
	
	/** 风控 黑白名单访问类型 */
	public static final String DATA_DICT_TYPE__NL_ACCESS_TYPE = "NL_ACCESS_TYPE";
	public static final String DATA_DICT_TYPE__NL_ACCESS_TYPE_VALUE = "黑白名单访问类型";
	
	/** 清结算产品服务 交易类型 */
	public static final String DATA_DICT_TYPE__CNL_TRANS_TYPE = "CNL_TRANS_TYPE";
	public static final String DATA_DICT_TYPE__CNL_TRANS_TYPE_VALUE = "清结算产品服务/交易类型";
	
	/** 清结算产品服务 用户渠道 */
	public static final String DATA_DICT_TYPE__CNL_CUST_CNL = "CUST_CNL";
	public static final String DATA_DICT_TYPE__CNL_CUST_CNL_VALUE = "清结算产品服务/用户渠道";
	
	/** 卡片帐管理 导出状态 */
	public static final String DATA_DICT_TYPE__EXPORT_STATUS = "EXPORT_STATUS";
	public static final String DATA_DICT_TYPE__EXPORT_STATUS_VALUE = "卡片帐管理/导出状态";
	
	/** 渠道接口管理 提现方式 */
	public static final String DATA_DICT_TYPE__WITHDRAW_TYPE = "WITHDRAW_TYPE";
	public static final String DATA_DICT_TYPE__WITHDRAW_TYPE_VALUE = "渠道接口管理/提现方式 ";
	
	/** 核心帐务 收付方向 */
	public static final String DATA_DICT_TYPE__PAYMENT_DC = "PAYMENT_DC";
	public static final String DATA_DICT_TYPE__PAYMENT_DC_VALUE = "核心帐务/收付方向 ";
	
	/** 核心帐务 业务类型 */
	public static final String DATA_DICT_TYPE__BUSINESS_TYPE = "BUSINESS_TYPE";
	public static final String DATA_DICT_TYPE__BUSINESS_TYPE_VALUE = "核心帐务/业务类型";
	
	/** 核心帐务 轧差状态*/
	public static final String DATA_DICT_TYPE__TRANSFER_STATUS = "TRANSFER_STATUS";
	public static final String DATA_DICT_TYPE__TRANSFER_STATUS_VALUE = "核心帐务/轧差状态";
	
	/** 接口数据管理 报文类型*/
	public static final String DATA_DICT_TYPE__MSG_TYPE = "MSG_TYPE";
	public static final String DATA_DICT_TYPE__MSG_TYPE_VALUE = "报文类型";
	
	/** 卡片帐管理 失败具体原因*/
	public static final String DATA_DICT_TYPE__FAIL_DTL_REASON = "FAIL_DTL_REASON";
	public static final String DATA_DICT_TYPE__FAIL_DTL_REASON_VALUE = "失败具体原因";
	
	/** 接口数据管理 回调失败报文发送状态*/
	public static final String DATA_DICT_TYPE__RETURN_MSG_STATUS = "RETURN_MSG_STATUS";
	public static final String DATA_DICT_TYPE__RETURN_MSG_STATUS_VALUE = "回调失败报文发送状态";
	
	/** 风控 统计类型*/
	public static final String DATA_DICT_TYPE__COLLECT_TYPE = "COLLECT_TYPE";
	public static final String DATA_DICT_TYPE__COLLECT_TYPE_VALUE = "统计类型";
	
	/** 风控 服务编号*/
	public static final String DATA_DICT_TYPE__CNL_INTF_NUM = "CNL_INTF_NUM";
	public static final String DATA_DICT_TYPE__CNL_INTF_NUM_VALUE = "服务编号";
	/** 退款管理 */
	public static final String DATA_DICT_TYPE__REFUND_REASON = "REFUND_REASON";
	public static final String DATA_DICT_TYPE__REFUND_REASON_VALUE = "退款原因";
	/** 公共管理	计费类型 */
	public static final String DATA_DICT_TYPE__SERVICE_FEE_TYPE = "SERVICE_FEE_TYPE";
	public static final String DATA_DICT_TYPE__SERVICE_FEE_TYPE_VALUE = "计费类型";
	/** 公共管理	备付金状态 */
	public static final String DATA_DICT_TYPE__RESERVED_FUND_ACNT_STATUS = "RESERVED_FUND_ACNT_STATUS";
	public static final String DATA_DICT_TYPE__RESERVED_FUND_ACNT_STATUS_VALUE = "备付金状态";
	
	
	// ------------------发送报文时的create_time字段可变常量配置-----------------------
	/** 渠道接口管理    报文接收时间窗口  */
	public static final String DATA_DICT_TYPE__MSG_REC_TIME_WINDOW = "MSG_REC_TIME_WINDOW";
	public static final String DATA_DICT_TYPE__MSG_REC_TIME_WINDOW_VALUE = "报文接收时间窗口";
	
	/** 明细来源 */
	public static final String DATA_DICT_DETAIL_SRC="DETAIL_SRC";
	public static final String DATA_DICT_DETAIL_SRC_VALUE="明细来源";
	
	public static final String DATA_DICT_TYPE__STL_DC = "STL_DC";
	public static final String DATA_DICT_TYPE__STL_DC_VALUE = "清算方向"; 
