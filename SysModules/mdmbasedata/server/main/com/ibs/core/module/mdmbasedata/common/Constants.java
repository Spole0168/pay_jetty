...
public class Constants {
	public final static String DETAIL_SRC01="01";//明细来源
	public final static String DETAIL_SRC01_VALUE= "手工";
	public final static String DETAIL_SRC02="02";//明细来源
	public final static String DETAIL_SRC02_VALUE= "系统";
	
	public final static int CALLBACK_FAILURE_OUT_TIME_ERR_CODE = 999;
	public final static String CALLBACK_FAILURE_OUT_TIME_ERR_VALUE ="发送报文超时";
	public final static int CALLBACK_FAILURE_OTHER_ERR_CODE = 998;
	public final static String CALLBACK_FAILURE_OTHER_ERR_VALUE ="报文发送后未收到应答信息";
	public final static int CALLBACK_FAILURE_HTTP_ERR_CODE = 000;
	public final static String CALLBACK_FAILURE_HTTP_ERR_VALUE ="http错误"; 
	...
	public final static String FAIL_REASON_04= "04";//入账管理/审核失败原因
	public final static String FAIL_REASON_04_VALUE= "其他";
	...
	public final static String PAYMENT_TYPE01= "1";//支付方式
	public final static String PAYMENT_TYPE01_VALUE= "手工";
	public final static String PAYMENT_TYPE02= "2";//支付方式
	public final static String PAYMENT_TYPE02_VALUE= "代扣";
	...
	//卡片账 - 提现审核状态
	public final static String WITHDRAW_CASH_APPROVAL_STATUS_PENDING = "01";
	public final static String WITHDRAW_CASH_APPROVAL_STATUS_PENDING_VALUE = "待审核";
	public final static String WITHDRAW_CASH_APPROVAL_STATUS_AUDIT_SUCCESS = "02";
	public final static String WITHDRAW_CASH_APPROVAL_STATUS_AUDIT_SUCCESS_VALUE = "审核成功";
	public final static String WITHDRAW_CASH_APPROVAL_STATUS_AUDIT_FAILED = "03";
	public final static String WITHDRAW_CASH_APPROVAL_STATUS_AUDIT_FAILED_VALUE = "审核失败";
	public final static String WITHDRAW_CASH_APPROVAL_STATUS_REVIEW_SUCCESS = "04";
	public final static String WITHDRAW_CASH_APPROVAL_STATUS_REVIEW_SUCCESS_VALUE = "复核成功";
	public final static String WITHDRAW_CASH_APPROVAL_STATUS_REVIEW_FAILED = "05";
	public final static String WITHDRAW_CASH_APPROVAL_STATUS_REVIEW_FAILED_VALUE = "复核失败";
	public final static String WITHDRAW_CASH_APPROVAL_STATUS_SUSPENDED = "06";
	public final static String WITHDRAW_CASH_APPROVAL_STATUS_SUSPENDED_VALUE = "提现挂起";
	...
	public final static String REQ_STATUS_TO_BE_VERIFIED = "06";//接口数据管理/接口数据申请单状态
	public final static String REQ_STATUS_TO_BE_VERIFIED_VALUE= "待验证";
	//清结算错误信息
	public static final String SUCC_RES_CODE = "0001";
	public static final String SUCC_RES_VALUE = "成功";
	public final static String CLEARING_ERROR_BALANCE_CODE = "0201";
	public final static String CLEARING_ERROR_BALANCE_VALUE = "清结算请求报文交易金额总和不为零";
	public final static String CLEARING_ERROR_DOING_CODE = "0202";
	public final static String CLEARING_ERROR_DOING_VALUE = "清结算仍在处理中";
	public final static String CLEARING_ERROR_BATCH_CODE = "0203";
	public final static String CLEARING_ERROR_BATCH_VALUE = "清结算请求数据总批次数错误";
	public final static String CLEARING_ERROR_COUNT_TATIL_CODE = "0204";
	public final static String CLEARING_ERROR_COUNT_TATIL_VALUE = "清结算请求数据总批次数错误";
	public static final String CLEARING_NUM_ERROR_CODE = "0103";
	public static final String CLEARING_NUM_ERROR_VALUE = "清算唯一编号不正确";
	...
	public final static String REQ_TRANS_ERROR_CODE_15="15";
	public final static String REQ_TRANS_ERROR_CODE_15_VALUE="清结算数据重复";
	...
	public final static String REQ_TYPE_SIGN_IN= "11";//签到
	public final static String REQ_TYPE_SIGN_IN_VALUE= "签到";
	public final static String REQ_TYPE_SIGN_OFF= "12";//签退
	public final static String REQ_TYPE_SIGN_OFF_VALUE= "签退";
	public final static String REQ_TYPE_INDIVIDUAL_QUERY= "13";//会员查询
	public final static String REQ_TYPE_INDIVIDUAL_QUERY_VALUE= "会员查询";
	public final static String REQ_TYPE_RECONCILIATION_QUERY= "14";//充值提现对帐查询
	public final static String REQ_TYPE_RECONCILIATION_QUERY_VALUE= "充值提现对帐查询";
	public final static String REQ_TYPE_CLEAR_QUERY= "15";//清结算结果查询
	public final static String REQ_TYPE_CLEAR_QUERY_VALUE= "清结算结果查询";
	public final static String REQ_TYPE_BANLANCE_QUERY= "16";//余额查询
	public final static String REQ_TYPE_BANLANCE_QUERY_VALUE= "余额查询";
	...
	public final static String TRANS_TYPE_CLEARING_OPENACCOUNT= "05";//卡片账/交易类型
	public final static String TRANS_TYPE_CLEARING_OPENACCOUNT_VALUE= "企业开户划账";
	
	public final static String TRANS_SUB_TYPE_FOR_WITHDRAW_AUDIT= "01";	//提现交易的子类型-提现审核/卡片帐用
	public final static String TRANS_SUB_TYPE_FOR_WITHDRAW_AUDIT_VALUE= "提现审核";
	...
	public final static String VIOLATION_TYPE_PAYMENT_EXCEED_LIMIT_VALUE= "出金超限";
	...
	public final static String CUST_TRACE_STATUS_FAIL ="07";
	public final static String CUST_TRACE_STATUS_FAIL_VALUE ="失败";
	...
	// 提现管理/导出状态
	public final static String WITHDRAW_RECORD_HANDLE_STATUS_NOT_EXPORT= "06";
	public final static String WITHDRAW_RECORD_HANDLE_STATUS_NOT_EXPORT_VALUE= "未导出";
	public final static String WITHDRAW_RECORD_HANDLE_STATUS_EXPORTED= "07";
	public final static String WITHDRAW_RECORD_HANDLE_STATUS_EXPORTED_VALUE= "已导出";
	public final static String WITHDRAW_RECORD_HANDLE_STATUS_REEXPORT= "08";
	public final static String WITHDRAW_RECORD_HANDLE_STATUS_REEXPORT_VALUE= "重新导出";
	
	// 风控 黑白名单访问类型
	public final static String NL_ACCESS_TYPE_01 = "01";
	public final static String NL_ACCESS_TYPE_01_VALUE ="允许";
	public final static String NL_ACCESS_TYPE_02 = "02";
	public final static String NL_ACCESS_TYPE_02_VALUE ="拒绝";
	
	// 清结算产品服务 交易类型
	public final static String CNL_TRANS_TYPE_01 = "01";
	public final static String CNL_TRANS_TYPE_01_VALUE ="买入";
	public final static String CNL_TRANS_TYPE_02 = "02";
	public final static String CNL_TRANS_TYPE_02_VALUE ="卖出";
	public final static String CNL_TRANS_TYPE_03 = "03";
	public final static String CNL_TRANS_TYPE_03_VALUE ="分成";
	public final static String CNL_TRANS_TYPE_04 = "04";
	public final static String CNL_TRANS_TYPE_04_VALUE ="税";
	
	// 清结算产品服务 用户渠道
	public final static String CUST_CNL_01 = "01";
	public final static String CUST_CNL_01_VALUE ="民生";
	public final static String CUST_CNL_02 = "02";
	public final static String CUST_CNL_02_VALUE ="钱宝";
	
	// 卡片帐管理 导出状态
	public final static String EXPORT_STATUS_01 = "01";
	public final static String EXPORT_STATUS_01_VALUE ="未导出";
	public final static String EXPORT_STATUS_02 = "02";
	public final static String EXPORT_STATUS_02_VALUE ="已导出";
	public final static String EXPORT_STATUS_03 = "03";
	public final static String EXPORT_STATUS_03_VALUE ="重新导出";
	
	// 渠道接口管理 提现方式
	public final static String WITHDRAW_TYPE_01 = "01";
	public final static String WITHDRAW_TYPE_01_VALUE ="手工";
	public final static String WITHDRAW_TYPE_02 = "02";
	public final static String WITHDRAW_TYPE_02_VALUE ="代付";
	
	// 核心帐务 收付方向
	public final static String PAYMENT_DC_01 = "01";
	public final static String PAYMENT_DC_01_VALUE ="收入";
	public final static String PAYMENT_DC_02 = "02";
	public final static String PAYMENT_DC_02_VALUE ="支出";
	
	// 核心帐务 业务类型
	public final static String BUSINESS_TYPE_01 = "01";
	public final static String BUSINESS_TYPE_01_VALUE ="入金";
	public final static String BUSINESS_TYPE_02 = "02";
	public final static String BUSINESS_TYPE_02_VALUE ="出金";
	public final static String BUSINESS_TYPE_03 = "03";
	public final static String BUSINESS_TYPE_03_VALUE ="个人实名验证";
	public final static String BUSINESS_TYPE_04 = "04";
	public final static String BUSINESS_TYPE_04_VALUE ="企业实名验证";
	
	// 核心帐务 轧差状态
	public final static String TRANSFER_STATUS_01 = "01";
	public final static String TRANSFER_STATUS_01_VALUE ="待处理";
	public final static String TRANSFER_STATUS_02 = "02";
	public final static String TRANSFER_STATUS_02_VALUE ="已轧差";
	public final static String TRANSFER_STATUS_03 = "03";
	public final static String TRANSFER_STATUS_03_VALUE ="未轧差";
	
	// 接口数据管理 报文类型
	public final static String MSG_TYPE_01 = "01";
	public final static String MSG_TYPE_01_VALUE ="充值通知接口";
	public final static String MSG_TYPE_02 = "02";
	public final static String MSG_TYPE_02_VALUE ="提现通知接口";
	public final static String MSG_TYPE_03 = "03";
	public final static String MSG_TYPE_03_VALUE ="清结算预处理完成通知接口";
	public final static String MSG_TYPE_04 = "04";
	public final static String MSG_TYPE_04_VALUE ="企业开户转账完成通知接口";
	public final static String MSG_TYPE_05 = "05";
	public final static String MSG_TYPE_05_VALUE ="清结算确认通知接口";
	public final static String MSG_TYPE_06 = "06";
	public final static String MSG_TYPE_06_VALUE ="轧差完成通知接口";
	
	// 卡片帐管理  失败具体原因
	public final static String FAIL_DTL_REASON_01 = "01";
	public final static String FAIL_DTL_REASON_01_VALUE ="财务驳回提现";
	public final static String FAIL_DTL_REASON_02 = "02";
	public final static String FAIL_DTL_REASON_02_VALUE ="收款帐户不存在";
	public final static String FAIL_DTL_REASON_03 = "03";
	public final static String FAIL_DTL_REASON_03_VALUE ="收款帐户异常";
	// 退款管理  --退款原因
	public final static String REFUND_REASON_01 = "01";
	public final static String REFUND_REASON_01_VALUE ="非绑定银行卡";
	public final static String REFUND_REASON_02 = "02";
	public final static String REFUND_REASON_02_VALUE ="打错款";
	public final static String REFUND_REASON_03 = "03";
	public final static String REFUND_REASON_03_VALUE ="其他";
	//公共管理	计费类型
	public final static String SERVICE_FEE_TYPE_01 = "01";
	public final static String SERVICE_FEE_TYPE_01_VALUE ="固定费率";
	public final static String SERVICE_FEE_TYPE_02 = "02";
	public final static String SERVICE_FEE_TYPE_02_VALUE ="按比例计费";
	public final static String SERVICE_FEE_TYPE_03 = "03";
	public final static String SERVICE_FEE_TYPE_03_VALUE ="按阶梯计费";
	
	// 接口数据管理  回调失败报文发送状态
	public final static String RETURN_MSG_STATUS_01 = "01";
	public final static String RETURN_MSG_STATUS_01_VALUE ="未发送";
	public final static String RETURN_MSG_STATUS_02 = "02";
	public final static String RETURN_MSG_STATUS_02_VALUE ="已发送";
	
	// 风控 统计类型
	public final static String COLLECT_TYPE_01 = "01";
	public final static String COLLECT_TYPE_01_VALUE ="当日出金额度";
	public final static String COLLECT_TYPE_02 = "02";
	public final static String COLLECT_TYPE_02_VALUE ="每周出金额度";
	public final static String COLLECT_TYPE_03 = "03";
	public final static String COLLECT_TYPE_03_VALUE ="当月出金额度";
	
	//公共管理	备付金状态
	public final static String RESERVED_FUND_ACNT_STATUS_01 = "01";
	public final static String RESERVED_FUND_ACNT_STATUS_01_VALUE ="正常";
	public final static String RESERVED_FUND_ACNT_STATUS_02 = "02";
	public final static String RESERVED_FUND_ACNT_STATUS_02_VALUE ="不正常";

	
	
	
	// 风控 服务编号
	public final static String CNL_INTF_NUM_01 = "NMG02002";
	public final static String CNL_INTF_NUM_01_VALUE ="NMG02002";
	public final static String CNL_INTF_NUM_02 = "NMG01001";
	public final static String CNL_INTF_NUM_02_VALUE = "NMG01001";
	public final static String CNL_INTF_NUM_03 = "NMG01002";
	public final static String CNL_INTF_NUM_03_VALUE = "NMG01002";
	public final static String CNL_INTF_NUM_04 = "NMG01005";
	public final static String CNL_INTF_NUM_04_VALUE = "NMG01005";
	public final static String CNL_INTF_NUM_05 = "NMG01007";
	public final static String CNL_INTF_NUM_05_VALUE = "NMG01007";
	public final static String CNL_INTF_NUM_06 = "NMG01006";
	public final static String CNL_INTF_NUM_06_VALUE = "NMG01006";
	public final static String CNL_INTF_NUM_07 = "NMG01003";
	public final static String CNL_INTF_NUM_07_VALUE = "NMG01003";
	public final static String CNL_INTF_NUM_08 = "NMG01004";
	public final static String CNL_INTF_NUM_08_VALUE = "NMG01004";
	public final static String CNL_INTF_NUM_09 = "NMG02001";
	public final static String CNL_INTF_NUM_09_VALUE = "NMG02001";
	public final static String CNL_INTF_NUM_10 = "NMG02003";
	public final static String CNL_INTF_NUM_10_VALUE = "NMG02003";
	public final static String CNL_INTF_NUM_11 = "NMG02004";
	public final static String CNL_INTF_NUM_11_VALUE = "NMG02004";
	public final static String CNL_INTF_NUM_12 = "NMG02005";
	public final static String CNL_INTF_NUM_12_VALUE = "NMG02005";
	public final static String CNL_INTF_NUM_13 = "NMG02006";
	public final static String CNL_INTF_NUM_13_VALUE = "NMG02006";
	public final static String CNL_INTF_NUM_14 = "NMG02007";
	public final static String CNL_INTF_NUM_14_VALUE = "NMG02007";
	public final static String CNL_INTF_NUM_15 = "NMG02008";
	public final static String CNL_INTF_NUM_15_VALUE = "NMG02008";
	public final static String CNL_INTF_NUM_16 = "NMG02009";
	public final static String CNL_INTF_NUM_16_VALUE = "NMG02009";
	public final static String CNL_INTF_NUM_17 = "NMG02010";
	public final static String CNL_INTF_NUM_17_VALUE = "NMG02010";
	public final static String CNL_INTF_NUM_18 = "NMG03001";
	public final static String CNL_INTF_NUM_18_VALUE = "NMG03001";
	public final static String CNL_INTF_NUM_19 = "NMG03002";
	public final static String CNL_INTF_NUM_19_VALUE = "NMG03002";
	public final static String CNL_INTF_NUM_20 = "NMG03003";
	public final static String CNL_INTF_NUM_20_VALUE = "NMG03003";
	 ...
	 * 手工清结算 清算方向
	 * */
	public final static String STL_DC_01 = "01";
	public final static String STL_DC_01_VALUE = "贷";
	
	public final static String STL_DC_02 = "02";
	public final static String STL_DC_02_VALUE = "借";
...
//	}
	...
	//shangzhuzi  签到签退 清算对账 状态 常量： 签到： 00-签到；签退：01-未处理， 02-处理中，03-已处理完成
	public final static String CLEARING_PROCESS_STATUS_00="00";
	public final static String CLEARING_PROCESS_STATUS_01="01";
	public final static String CLEARING_PROCESS_STATUS_02="02";
	public final static String CLEARING_PROCESS_STATUS_03="03";
	public final static String CLEARING_PROCESS_STATUS_04="04";
	 ...
	 * 新增：shangzhuzi
	 */
	public final static String CERTIFICATION_LEVEL_ONE = "01";
	
	/**
	 * 内蒙古签名开关
	 */
	public final static String NMG_NOTIFICATION_SIGN_ENABLE = "nmg.notification.sign.enable";
	/**
	 * 服务签到签退常量
	 * shangzhzuzi
	 */
	public final static String SERVICE_STATUS_OPEN = "01";
	public final static String SERVICE_STATUS_CLOSE = "02";
	 ...
	 * zhaokaijie
	 */
	public final static BigDecimal DEFAULT_TRANS_RATE = new BigDecimal("1");
	...
	//审核类型
	public final static String AUDIT_TYPE_MERCHANT ="MERCHANT";
