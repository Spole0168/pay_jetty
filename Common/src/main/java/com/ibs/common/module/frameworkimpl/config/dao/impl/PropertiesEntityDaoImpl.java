...
public class PropertiesEntityDaoImpl extends BaseEntityDao<Properties>
	...
	public HashMap<String, String> findAllValid() {
		...
		String sql = "SELECT key, value FROM T_PBL_PROPERTIES where status = ?";
	...
	public Page<Properties> findConfigByPage(QueryPage queryPage,
		...
		sqlBuffer
				.append("select id as id,key as key,value as value,description as description,status as status from T_pbl_properties where 1=1");
