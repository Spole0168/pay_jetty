...
public class BeanUtils extends org.apache.commons.beanutils.BeanUtils {
     ...
     * 用copyObjectTypeProperties把修改后的的数据赋值到load出来的对象即可。 赋值时要求： 1.名称相同的属性
     * 2.类型相同的属性 3.源对象属性值不可为null或者空 的属性 可参考
     * com.ibs.core.module.customer.biz.impl.CorMertRateBizImpl
     * 方法：saveOrUpdateInfo
     */
