...
public class StringUtils extends org.apache.commons.lang.StringUtils {
    ...
    public static String getStringAsISO8859_1(String source) throws UnsupportedEncodingException {
        if (null == source)
            return source;
     ...
     * @return
     */
    public static List<String> delimiterScanner(String arg, String delimiter, boolean trim) {
    ...
    public static Map<String, String> parseParameter(String bizParameters) {
        return parseParameter(bizParameters, PARAM_SEPARATOR, KEY_VALUE_SEPARATOR);
    }

    public static Map<String, String> parseParameter(String bizParameters, String paramSeparator,
    ...
    public static boolean hasWaybillNoInput(String waybillNo) {
        ...
        for (int i = 0; i < temp_waybillNo.length; i++) {
            if (org.apache.commons.lang.StringUtils.isNotBlank(temp_waybillNo[i])) {
                return true;
            }
        }
        return false;
    ...
    public static <T> List<String> concatOracleInString(List<T> values) {
        ...
        if (t instanceof String) {
            sep = "'";
        } else if (t instanceof Long || t instanceof Integer || t instanceof Short) {
