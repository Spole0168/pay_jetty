...
// 	                	}
		...
		var addOrModifyRole = "#addNewRole";
		...
		//	$("#roleForm").submit();
			...
			//alert("新增角色。。。。。");
			$(addOrModifyRole).dialog({width:1000,height:100,modal:true});
			openDialog2(addOrModifyRole,title,url);
	...
	*/		
	...
	function modifyRole(id){
		...
		//alert("修改角色信息。。。。。");
		$("#addNewRole").dialog({width:1000,height:100,modal:true});
		openDialog2("#addNewRole",title,url);
	...
	*/	if(a != null){
	...
	function openDialog2(dlgId, title, url){
		$(dlgId).html("");
		$(dlgId).dialog({
			autoOpen:false,
			position:['center',50],
...
<div class="block m-b">
 ...
 <div id="toolbar">
		...
		<span id="addNewRole" class="fieldset_container"/> 
	</div>
